...
const translations: Record<Locale, Record<I18nKey, string>> = {
	"zh-CN": {
		...
		"setting.excludePathsDesc2": "不备份的路径前缀，每行一个（如 .trash, .DS_Store）。Obsidian 配置目录会自动排除",
	...
	en: {
		...
		"setting.excludePathsDesc2": "Path prefixes to exclude, one per line (e.g. .trash, .DS_Store). The Obsidian config folder is auto-excluded",
